...
SNAPSHOT_PLAYERS: list[Player] = [
    ...
    Player("39", "川原颯斗", "DF"), Player("43", "野瀬翔也", "DF"),
    ...
    Player("30", "田中宏武", "MF"), Player("31", "堀米悠斗", "MF"),
    Player("34", "木實快斗", "MF"), Player("35", "原康介", "MF"),
    Player("9", "マリオ・セルジオ", "FW"), Player("19", "ティラパット", "FW"),
    Player("20", "アマドゥ・バカヨコ", "FW"), Player("22", "キングロード・サフォ", "FW"),
    Player("23", "大森真吾", "FW"), Player("38", "唐山翔自", "FW"),
    Player("40", "佐藤陽成", "FW"), Player("70", "ヴィニ・ペイショット", "FW"),
    Player("71", "白井陽斗", "FW"),
]
